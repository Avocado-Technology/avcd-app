...
export type EmployeeFieldsFragment = { __typename: 'Employee', id: string, name: string, address: string, salary: number, organizationId: string };
...
export type GetEmployeesByOrganizationQuery = { employees: Array<{ __typename: 'Employee', id: string, name: string, address: string, salary: number, organizationId: string }> };
